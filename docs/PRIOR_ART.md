...
| [NVIDIA Agent Intelligence Toolkit](https://docs.nvidia.com/nemo/agent-toolkit/1.1/) | Reusable functions, tools, Agents, workflows, evaluation, profiling, and observation integrations | It can host provider or Procedure implementations. This architecture does not replace its workflow, evaluation, registry, or deployment surface. |
